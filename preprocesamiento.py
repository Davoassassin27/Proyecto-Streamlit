...
def preprocesamiento():
    ...
    #st.session_state.df = pd.read_csv('datasets\dataset_abandono.csv') 
    ...
    if "df" not in st.session_state:
            ...
            st.write("Debe Ingresar el dataset primero, Dirijase a la página principal.") 
    else:
        ...
        with col_trans:
                st.markdown("### Transformar Valores Vacíos Categóricos")
        ...
        with col_label:
            st.markdown("### Transformar Valores Vacíos Numéricos")
            col_selec, col_boton = st.columns(2)
            with col_selec:
        ...
        with col_standar:
            ...
            with col_eliminar:
                ...
                selector_atipico = st.selectbox("Elija el método", ("Boxplot", "Isolation Forest"))
        ...
        if st.session_state.boton_pasos_no_realizados:
            ...
            #st.session_state.predf.to_csv('datasets/datos_preprocesados.csv',index=None)
